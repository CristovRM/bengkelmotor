                    ...
                    @foreach($kategori as $item)
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-center">
                                <a href="{{ route('kategori.show', $item->id) }}" class="mr-2 text-blue-600 hover:text-blue-900">Detail</a>
                                <a href="{{ route('kategori.edit', $item->id) }}" class="mr-2 text-indigo-600 hover:text-indigo-900">Edit</a>
