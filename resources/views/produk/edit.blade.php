...
<div class="container mx-auto px-4 py-8" style="width: 800px;">
    ...
    <form action="{{ route('produk.update', $produk['id_produk']) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="merk" name="merk" value="{{ $produk['merk'] }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="number" id="diskon" name="diskon" value="{{ $produk['diskon'] }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>
        <div class="mb-4">
