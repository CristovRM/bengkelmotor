                ...
                <tbody class="text-gray-600 text-sm font-light">
                    @foreach($produk as $item)
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-left">{{ $item['supplier']['nama_supplier'] }}</td>
                            ...
                            <td class="py-3 px-6 text-center">
                                <a href="{{ route('produk.show', $item['id_produk']) }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Detail</a>
                                <a href="{{ route('produk.edit', $item['id_produk']) }}" class="bg-yellow-500 text-white px-4 py-2 rounded hover:bg-yellow-600">Edit</a>
